...
set "License="
set "Extract7z="
set "SOFTNAME=TeamViewer Quick Support"
set "PROCESS=TeamViewerQS.exe"
set "CheckOSVersion=No"
set "USERAGENT=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.3"

:: Set code based on Windows Architecture
:: Source link: https://download.teamviewer.com/QS

set "LINK=https://download.teamviewer.com/QS"
set "QUIETMODE="
set "SOFTPATH="
