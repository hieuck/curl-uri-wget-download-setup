...
set "FileName="
set "SoftNameVersion="
set "FileDLwB=Unigine*Heaven*.exe"
...
REM Source Link: https://benchmark.unigine.com/heaven
...
set "SoftPath="
set "SoftPathFor32bit=%ProgramFiles%\Unigine\Heaven Benchmark 4.0"
set "SoftPathFor64bit=%ProgramFiles(x86)%\Unigine\Heaven Benchmark 4.0"
