...
set "SoftName=RivaTuner Statistics Server"
set "Process=MSIAfterburner.exe"

set "FileName="
set "SoftNameVersion="
set "FileDLwB=MSIAfterburner*.exe"
...
set "Link=https://download.msi.com/uti_exe/vga/MSIAfterburnerSetup466Beta3.zip?__token__=exp=1731284506~acl=/*~hmac=d56ec4f811828e4459caa10174568656c2e69d1e7167ea24d4d94dfcc243de99"
set "LinkForAllWindows32bit="
set "LinkForAllWindows64bit="

set "LinkFromGithub=MSIAfterburnerInstaller466Beta3.exe"
set "LinkFromDropbox="
set "LinkFromOneDrive="

set "SoftPath="
set "SoftPathFor32bit=%ProgramFiles%\RivaTuner Statistics Server"
set "SoftPathFor64bit=%ProgramFiles(x86)%\RivaTuner Statistics Server"
