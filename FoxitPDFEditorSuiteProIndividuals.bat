...
REM Source Link: https://www.foxit.com/downloads/pdf-editor-thanks.html?product=Foxit-PDF-Editor-Suite-Pro-Individuals&platform=Windows&version=&package_type=exe&language=English&formId=trial-foxit-sign-suite-pro-individual&page=suite-individual

set "LinkForOldWindows="
set "LinkForOldWindows32bit="
set "LinkForOldWindows64bit="

set "Link=https://www.foxit.com/downloads/pdf-editor-thanks.html?product=Foxit-PDF-Editor-Suite-Pro-Individuals&platform=Windows&version=&package_type=exe&language=English&formId=trial-foxit-sign-suite-pro-individual&page=suite-individual"
