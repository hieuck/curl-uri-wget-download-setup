...
set "SoftName=Sandboxie Plus"
set "Process=SandMan.exe"

set "FileName="
set "SoftNameVersion=1.11.2"
set "FileDLwB=Sandboxie*.exe"
...
set "Link=%Link%"
set "LinkForAllWindows32bit=https://github.com/sandboxie-plus/Sandboxie/releases/download/v!SoftNameVersion!/Sandboxie-Plus-x86-v!SoftNameVersion!.exe"
set "LinkForAllWindows64bit=https://github.com/sandboxie-plus/Sandboxie/releases/download/v!SoftNameVersion!/Sandboxie-Plus-x64-v!SoftNameVersion!.exe"

set "SoftPath=%ProgramFiles%\Sandboxie-Plus"
