...
set "SoftName=CPUID HWMonitor"
set "Process=HWMonitor.exe"

set "FileName="
set "SoftNameVersion=1.60"
...
REM Source Link: https://www.cpuid.com/softwares/hwmonitor.html
...
if "%choice%"=="1" (
	...
	set "Link=https://download.cpuid.com/hwmonitor/hwmonitor_!SoftNameVersion!.exe"
...
set "SoftPath=%ProgramFiles%\CPUID\HWMonitor"
